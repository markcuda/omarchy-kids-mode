...
`lib/transport.dart` (the trust anchor: the certificate's SPKI SHA-256, the value the parent reads
off the pairing screen and the app pins). The
...
There is no Flutter project and nothing to install
