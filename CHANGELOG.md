...
- Panel P2 now covers the rest of R-WIZ-8's "every setting": weekday **and weekend** daily
  ...
  confirmed **Reset to band defaults** that keeps the account, name, face, band, password and
  theme; every other setting, including any sites added by hand, goes back to the band's defaults.
